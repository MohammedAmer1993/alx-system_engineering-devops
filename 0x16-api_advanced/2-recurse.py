#!/usr/bin/python3
"""
the recursive way to get top ten posts.
"""

import requests


def recurse(subreddit, topTenList=[], after="", count=0):
    """
    ...
    Args:
        ...
        topTenList (list, optional): List to store the post titles.
    ...
    for c in results.get("children"):
        topTenList.append(c.get("data").get("title"))

    if after is not None:
        return recurse(subreddit, topTenList, after, count)
